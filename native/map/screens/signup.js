...
export default function Signup({ navigation }) {
  ...
  return (<>
    <View style={[styles.flexCenter, styles._black, styles.textBlack, styles.w100, styles.h100, styles.p3]}>
      ...
      <TextInput placeholder='username' onChangeText={e => setModel({ ...model, username: e })} placeholderTextColor={"white"} style={[styles.mb2, styles.input, styles.bgBlack, styles.px2]} />
      <TextInput placeholder='email@gmail.com' onChangeText={e => setModel({ ...model, email: e })} placeholderTextColor={"white"} style={[styles.mb2, styles.input, styles.bgBlack, styles.px2]} />
      <TextInput placeholder='**********' onChangeText={e => setModel({ ...model, password: e })} placeholderTextColor={"white"} style={[styles.mb2, styles.input, styles.bgBlack, styles.px2]} secureTextEntry={true} />

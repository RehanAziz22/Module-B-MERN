...
export default function SplashScreen({navigation}) {
  ...
  <View style={[styles.flexCenter,styles._black,styles.textBlack,styles.w100,styles.h100]}>
    <Text style={[styles.textDanger,styles.fs1,styles.textBold]}>Splash Screen</Text>
    <Text style={[styles.textBlack,styles.textBold,styles.fs6,styles.mt2,styles.w75,styles.textCenter]}>Splash screen text</Text>

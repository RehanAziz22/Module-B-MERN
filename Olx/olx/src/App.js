...
function App() {
  const array = [
    ...
    },
    {
      ...
      title:
        "Avail Yourself A Great 1350 Square Feet Flat In Badar Commercial Area",
      price: "Rs 50,000",
      location: "Badar Commercial Area, Karachi",
    },
  ];

  function genetrateCards() {
    ...
    <div className="App">
      <header className="App-header">
        ...
        <Container maxWidth="xl" sx={{ textAlign: "center" }}>
          <h3 style={{ color: "#002f34", textAlign: "left" }}>
        ...
        <Container maxWidth="md">
          <img
            style={{ width: "100%" }}
            src="https://s0.2mdn.net/simgad/3922715619172844932"
          />
        </Container>
        <BottomBanner />
      </header>
